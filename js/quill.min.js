			...
			a = function(t) {
				function e(e) {
					...
					return n.scroll = n, n.observer = new MutationObserver(function(t) {
						if( t[0] && t[0].addedNodes[0] && t[0].addedNodes[0].id === 'math-edit' ) return;
						if( t[1] && t[1].addedNodes[0] && t[1].addedNodes[0].id === 'math-edit' ) return;
						n.update(t)
		...
		var a = function() {
			...
			y = function(t) {
				...
				return l(e, t), a(e, null, [{
					...
					value: function(t) {
						var n = s(e.__proto__ || Object.getPrototypeOf(e), "create", this).call(this, t);
						$$("ql-formula") && $$("ql-formula").removeAttribute('id');
						n.id = "ql-formula";
